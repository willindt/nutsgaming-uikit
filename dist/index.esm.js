...
var templateObject_1$G, templateObject_2$d, templateObject_3$6;
...
var Icon$O = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 150 40" }, props),
        React.createElement("image", { width: "150", height: "40", href: isDark ? '/images/egg/LogoTextNewDark.png' : '/images/egg/LogoTextNewWhite.png' })));
};
...
var templateObject_1$B, templateObject_2$c, templateObject_3$5, templateObject_4$2;
...
var templateObject_1$e, templateObject_2$6, templateObject_3$3, templateObject_4$1, templateObject_5$1;
...
var templateObject_1$c, templateObject_2$4, templateObject_3$1;
...
var Logo = function (_a) {
    ...
    var innerLogo = (React.createElement(React.Fragment, null,
        React.createElement(Icon$O, { className: "mobile-icon", isDark: isDark }),
...
styled(Link)(templateObject_1$8 || (templateObject_1$8 = __makeTemplateObject(["\n  display: flex;\n  align-self: center;\n  align-items: center;\n  margin-top: 24px;\n"], ["\n  display: flex;\n  align-self: center;\n  align-items: center;\n  margin-top: 24px;\n"])));
...
var MoonIcon = Icons$1.MoonIcon, SunIcon = Icons$1.SunIcon; Icons$1.LanguageIcon; Icons$1.MoreIcon;
styled(Dropdown)(templateObject_1$5 || (templateObject_1$5 = __makeTemplateObject(["\n  ", " {\n    display: block;\n  }\n\n  display: none;\n"], ["\n  ", " {\n    display: block;\n  }\n\n  display: none;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
...
var UserBlock = function (_a) {
    ...
    return (React.createElement(Flex, null,
        React.createElement(Dropdown, { position: "top-right", target: React.createElement(Button, { size: "sm", variant: "text" },
                React.createElement(Text, { color: "textSubtle" }, currentLang ? currentLang === null || currentLang === void 0 ? void 0 : currentLang.toUpperCase() : "EN")) }, langs.map(function (lang) { return (React.createElement(MenuButton, { key: lang.code, fullWidth: true, onClick: function () { return setLang(lang); }, 
            // Safari fix
            style: { minHeight: "32px", height: "auto" } }, lang.language)); })),
        React.createElement(StyledButton, { size: "sm", onClick: function () { return toggleTheme(!isDark); } },
            React.createElement(Flex, { alignItems: "center" }, isDark ? (React.createElement(SunIcon, { color: "white", width: "24px" })) : (React.createElement(MoonIcon, { color: "white", width: "24px" })))),
        React.createElement(StyledButton, { size: "sm", color: "white", onClick: function () {
                buy();
            } },
            React.createElement("img", { src: "/images/egg/mastercard.png", width: "60px" })),
        account ? (React.createElement(StyledButton, { size: "sm", color: "white", onClick: function () {
                onPresentAccountModal();
            } }, accountEllipsis)) : (React.createElement(StyledButton, { size: "sm", onClick: function () {
...
var StyledNav = styled.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  display: grid;\n  grid-template-columns: 1fr 0px;\n  -webkit-box-pack: justify;\n  justify-content: space-between;\n  -webkit-box-align: center;\n  align-items: center;\n  flex-direction: row;\n  width: 100%;\n  top: 0px;\n  position: relative;\n  z-index: 2;\n"], ["\n  display: grid;\n  grid-template-columns: 1fr 0px;\n  -webkit-box-pack: justify;\n  justify-content: space-between;\n  -webkit-box-align: center;\n  align-items: center;\n  flex-direction: row;\n  width: 100%;\n  top: 0px;\n  position: relative;\n  z-index: 2;\n"])));
var StyledNavLeft = styled.nav(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  top: 0;\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 24px;\n  padding-right: 16px;\n  height: ", "px;\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n  width: fit-content;\n  @media only screen and (max-width: 960px) {\n    width: 100%\n\t}\n"], ["\n  top: 0;\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 24px;\n  padding-right: 16px;\n  height: ", "px;\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n  width: fit-content;\n  @media only screen and (max-width: 960px) {\n    width: 100%\n\t}\n"])), MENU_HEIGHT);
var StyledNavRight = styled.nav(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  display: flex;\n  justify-self: flex-end;\n  @media only screen and (max-width: 960px) {\n    position: fixed;\n    bottom: 0;\n    left: 0;\n    transition: bottom 0.2s;\n    width: 100%;\n    justify-content: space-between;\n    align-items: center;\n    height: ", "px;\n    border-top: solid 2px rgba(133, 133, 133, 0.1);\n    z-index: 20;\n    background-color:  ", ";\n\t}\n"], ["\n  display: flex;\n  justify-self: flex-end;\n  @media only screen and (max-width: 960px) {\n    position: fixed;\n    bottom: 0;\n    left: 0;\n    transition: bottom 0.2s;\n    width: 100%;\n    justify-content: space-between;\n    align-items: center;\n    height: ", "px;\n    border-top: solid 2px rgba(133, 133, 133, 0.1);\n    z-index: 20;\n    background-color:  ", ";\n\t}\n"])), MENU_HEIGHT, function (_a) {
    var theme = _a.theme;
...
Icons.MoonIcon; Icons.SunIcon; Icons.LanguageIcon; var MoreIcon = Icons.MoreIcon;
        ...
        React.createElement(StyledNav, null,
            React.createElement(StyledNavLeft, { showMenu: showMenu },
                ...
                React.createElement(StyledLinkContainer, null,
                    React.createElement(StyledNavLink, { as: "a", href: "https://charts.bogged.finance/?token=0xc28abfd5283e724f45ef71d59311d433b4b301fa" },
                        React.createElement(Text, { fontSize: "20px" }, t('menuchart'))),
                    React.createElement(StyledNavLink, { as: "a", href: "https://halwaswap.com/about" },
                        React.createElement(Text, { fontSize: "20px" }, t('menuabout'))),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#758994", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#dceaf1", text: "#FFBA00", textDisabled: "#BDC2C4", textSubtle: "#8f80ba", borderColor: "#E9EAEB", card: "#FFFFFE", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#343135", backgroundDisabled: "#3c3742", contrast: "#FFFFFD", invertedContrast: "#191327", input: "#10161C", primaryDark: "#0098A1", tertiary: "#343a40", text: "#FFFFFF", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "#1E262F", gradients: {
